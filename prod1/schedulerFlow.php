                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Scheduler Flow Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="schedulerFlowdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="schedulerFlowdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="schedulerFlow.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><strong>Level 5</strong></th>
                                  <th><strong>Level 6</strong></th>
                                  <th><strong>Level 7</strong></th>
                                  <th><strong>Level 8</strong></th>
                                  <th><strong>Level 9</strong></th>
                                  <th><strong>Level 10</strong></th>
                                  <th><strong>Level 11</strong></th>
                                  <th><strong>Level 12</strong></th>
                                  <th><strong>Level 13</strong></th>
                                  <th><strong>Level 14</strong></th>
                                  <th><strong>Level 15</strong></th>
                                  <th><strong>Level 16</strong></th>
                                  <th><strong>Level 17</strong></th>
                                  <th><strong>Level 18</strong></th>
                                  <th><strong>Level 19</strong></th>
                                </tr>
                              </thead>
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  if ($numdocs == 0) {
                                    $input = str_replace(" ", "-", $input);
                                    $results = $collection->find($inputs)->limit(500)->skip($from);
                                  }
                                } else {
                                ...
                                echo '<tbody>';
                                  ...
                                  echo '<tr>';
                                  for($i=1;$i<20;$i++){
                                    array_push($chartValues, $values['level'.$i]);
                                  }
                                  $chartValues = array_filter($chartValues);
                                  $chartValue = implode(";", $chartValues);
                                  for($i=1;$i<20;$i++){
                                    if($i == 1){
                                    echo '<td><a href="schedulerFlowChart.php?first_level='. $chartValue .'">' . $values['level'.$i] . '</td>';
                                  }else{
                                    echo '<td>' . $values['level'.$i] . '</td>';
                                  }
                                }
                                  echo '</tr>';
                                }
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="schedulerFlow.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="schedulerFlow.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
