    ...
    <script type="text/javascript">
        ...
        network.on("doubleClick", function(params) {
            if (params.nodes.length > 0) {
                ...
                if (!!nodeType) {
                    if (!!nodeBusiness) {
                        window.location.href = "controlFlowTest.php?input=" + nodeLabel + "." + nodeType + "&business=" + nodeBusiness;
                    } else {
                        window.location.href = "controlFlowTest.php?input=" + nodeLabel + "." + nodeType;
                    }
                } else {

                    if (!!nodeBusiness) {
                        window.location.href = "controlFlowTest.php?input=" + nodeLabel + "&business=" + nodeBusiness;
                    } else {
                        window.location.href = "controlFlowTest.php?input=" + nodeLabel;
                    }
                }
            }
        });
