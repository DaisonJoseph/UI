                ...
                <div class="page-content" style="background-color:#DCDCDC;">
                    ...
                    <div>
                       ...
                       <div class="row" style="margin-top:-5px">
                            ...
                            <!-- ?USES :- For comparing the relative number of defects in various software components so that high-risk components can be identified and resources focused towards them. -->
						 <div class="col-sm-2 col-xs-12" title="Defect Density is the number of confirmed defects detected in software/component during a defined period of development/operation divided by the size of the software/component (Measured in - Source Lines of Code).">
                            ...
                            <div class="col-sm-3 col-xs-12" title="The defect removal efficiency (DRE) gives a measure of the development team ability to remove defects prior to release. It is calculated as a ratio of defects resolved to total number of defects found. It is typically measured prior and at the moment of release.">
                                <a class="dashboard-stat dashboard-stat-v2 green-jungle" style="cursor:default">
                                    ...
                                    <div class="details">
                                        <div class="number">
                                        <?php $fixedCount = $defectCol->find(array("BG_STATUS"=>"Fixed"))->count(); $total_dre = ($fixedCount * 100000) / $total_valid_defects; echo $total_dre; ?> 
                            ...
                            <div class="col-xs-12 col-sm-12">
                                <div class="portlet light bordered grey-mint" id="secondscroll">
                                    <div class="portlet-title">
                                        <div class="caption">
                                            <span class="caption-subject font-white bold">Testcases</span>
                                        </div>
                                        <div class="tools">
                                    ...
                                    <div class="portlet-body">
										<div class="row">
											...
											<div class="col-sm-7 active">
                                                ...
                                                <button type="button" onClick="refreshPage()" style="border:1px solid black;">Refresh</button>
													<div class="portlet-body">
                                                   

															<div id="phasediv1" class="chart text-center" style="height:350px; width:100%"></div>
                                            ...
                                            <div class="col-sm-5">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="purdefect" class="chart text-center" style="height:375px; width:100%"></div>
													</div>
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="pfbdiv" class="chart text-center" style="height:350px; width:100%"></div>
													</div>
												</div>
											</div>
											...
											<div class="col-sm-4">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="statuschart" class="chart text-center" style="height:350px; width:100%"> </div>
													</div>
												</div>
											</div>
                                            <div class="col-sm-4">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="priorities" class="chart text-center" style="height:350px; width:100%" ></div>
													</div>
												</div>
											</div>
                                            <!-- <div class="col-sm-12">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="donutchart" class="chart text-center" style="height:400px; width:100%" ></div>
													</div>
												</div>
											</div> -->
                        ...
                        <div class="row">
                         <div class="col-xs-12 col-sm-12">
								<div class="portlet light bordered" style="background-color:#ffffff" id="secondscroll">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-bar-chart font-dark hide"></i>
										<span class="caption-subject font-dark bold">Test Case by Application Cluster</span>
										</div>
										<div class="tools">
											<a href="" class="collapse"> </a>
										</div>
									...
									<div class="portlet-body" >
										<div id="donutchart" class="chart text-center" style="height:380px"></div>
									</div>	
								</div>
							</div>
                            <div class="col-xs-12 col-sm-6">
								<div class="portlet light bordered" style="background-color:#ffffff" id="secondscroll">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-bar-chart font-dark hide"></i>
										<span class="caption-subject font-dark bold">Status of Actual vs Scheduled Task</span>
										</div>
										<div class="tools">
											<a href="" class="collapse"> </a>
										</div>
									...
									<div class="portlet-body" >
										<div id="newdiv" class="chart text-center" style="height:380px"></div>
									</div>	
								</div>
							</div>	
							...
							<div class="col-xs-12 col-sm-6">
								...
								<div class="portlet light bordered" style="background-image: url(../assets/portletImages/clock.jpg); background-size: cover;">
									<div class="portlet-title">
										<div class="caption">
											<i class="icon-bar-chart font-dark hide"></i>
											<span class="caption-subject bold" style="font-size:19px;color:white;font-family:Arial">Time to complete remaining work</span>
										</div>
										<div class="tools">
											<a href="" class="collapse"> </a>
										</div>
									...
									<div class="portlet-body">
										<div class="chart text-center overflow" style="height: 380px;font-family:Arial"> 
										<br><br><br>
											<div id="clockdiv">
											<!-- <h1></h1> -->
											  <div class="size">
												<span class="days"></span>
												<div class="smalltext" style="font-family:Arial">Days</div>
											  </div>
											  <div class="size">
												<span class="hours"></span>
												<div class="smalltext" style="font-family:Arial">Hours</div>
											  </div>
											  <div class="size">
												<span class="minutes"></span>
												<div class="smalltext" style="font-family:Arial">Minutes</div>
											  </div>
											  <div class="size">
												<span class="seconds"></span>
												<div class="smalltext margin" style="font-family:Arial">Seconds</div>
											  </div>
											</div>
										</div>
									</div>
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-12">
                                <div class="portlet light bordered grey-mint" id="secondscroll"> 
                                     <div class="portlet-title">
                                        <div class="caption">
                                            <span class="caption-subject font-white bold">Test Cases</span>
                                        </div>
                                        <div class="tools">
                                            <a href="" class="collapse"> </a>
                                        </div>
										...
										<div class="row">
											<br>
											 ...
											 <!-- <div class="col-sm-6">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbyexecper" class="chart text-center" style="height:350px"></div>
													</div>
												</div>
											</div>											 -->
											<div class="col-sm-12">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbyexecno" class="chart text-center" style="height:380px"></div>
													</div>
												</div>
                                            </div>
                                            <!-- <div class="col-sm-12">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbynode" class="chart text-center" style="height:350px"></div>
													</div>
												</div>
                                            </div> -->
                                            <!-- <div class="col-sm-12">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbynodeper" class="chart text-center" style="height:350px"></div>
													</div>
												</div>
											</div> -->
                                            <div class="col-sm-7">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbypriority" class="chart text-center" style="height:380px"></div>
													</div>
												</div>
											</div>
                                            <div class="col-sm-5">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testbystate" class="chart text-center" style="height:380px"></div>
													</div>
												</div>
											</div> 
                                            <div class="col-sm-6">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
															<div id="perautomated" class="chart text-center" style="height:380px"></div>
													</div>
												</div>
											</div>
											<div class="col-sm-6">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="testautomation" class="chart text-center" style="height:380px"></div>
													</div>
												</div>
											</div>
                                            <!-- <div class="col-sm-6">
												<div class="portlet light" style="background-color:#ffffff">
													<div class="portlet-body">
														<div id="codeExecuted" class="chart text-center" style="height:350px"></div>
													</div>
												</div>
											</div>                                     							 -->
										 </div>
