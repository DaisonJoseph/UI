<?php
						...
						if(isset($_GET['input']))
						{
							header("Content-Disposition: attachment; filename=staticRecompileImpact_" . $_GET['input'] . "_Download.csv");
						}
						else
						{
							header("Content-Disposition: attachment; filename=staticRecompileImpact.csv");
						}
						$m = new MongoClient();
						$db = $m->ryder;
