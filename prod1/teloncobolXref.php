                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>Telon Cobol Cross Reference</h2>
                                                                      <?php
                                                                      if (isset($_GET['input'])) {
                                                                           $business = $_GET['input'];
                                                                           $business = str_replace(" ", "+", $business);
                                                                           echo '<h5><a href="teloncobolXrefDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="teloncobolXrefDownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>
                                                                      <form action="teloncobolXref.php" class="searchform">
                                                                 ...
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           ...
                                                                           if (isset($_GET['input']) || isset($_GET['search'])) {
                                                                                ...
                                                                                $results = $collection->find(array('calling_component_type' => "TELONCBL"))->limit(500)->skip($from);
                                                                           }
                                                                           echo '<tbody>';
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                ?>
                                                                                     <a href="teloncobolXref.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom . " - " . $previousTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                if (isset($nextFrom)) {
                                                                                ?>
                                                                                     <a href="teloncobolXref.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom . " - " . $nextTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
