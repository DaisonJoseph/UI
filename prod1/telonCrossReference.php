                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Telon Cross Reference</h2>
                                                               <?php
								if (isset($_GET['input']))
								{	
									$business =$_GET['input'];
									$business = str_replace(" ","+",$business);
									echo '<h5><a href="telonCrossReferenceReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="telonCrossReferenceReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>


                            <form action="telonCrossReference.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
								  ...
								  <th><strong>Static/Dynamic</strong></th>
                                </tr>
                              </thead>
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("Calling_Component_name" => 1,"Calling_Component_type"=>1,"Called_Component_name"=>1,"Called_Component_type"=>1,"Static/Dynamic"=>1))->limit(500)->skip($from-1);
                                ...
                                foreach ($results as $result) {
                                  ...
                                  echo '<tr>';
                                  echo '<td>' . $callingComponentName . '</td>';
                                  echo '<td>' . $callingComponentType . '</td>';
								  echo '<td>' . $calledComponentName . '</td>';
                                  echo '<td>' . $calledComponentType . '</td>';
								  echo '<td>' . $typeOfCall . '</td>';
