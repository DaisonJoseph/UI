...
$total = $collection->find(array('orphan' => 'Yes'))->count();
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Orphan Components Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="orphanReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="orphanReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="orphanReport.php" class="searchform">
                          ...
                          <div class="table-responsive">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
								  ...
								  $inputs =  array( '$or' => array(
									array( '$and' => array( array('component_name' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('component_type' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('sub_type' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('uloc' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('cloc' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('tloc' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('instance' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('app_code' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('app_name' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('app_owner_name' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes"))),
									array( '$and' => array( array('platform' => new MongoRegex("/^$input/i")),array( 'orphan' => "Yes")))
                                  ...
                                  $results = $collection->find(array('orphan' => 'Yes'))->sort(array("component_type" => 1))->limit(500)->skip($from);
                                }
                                echo '<tbody>';
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="orphanReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="orphanReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
