...
if (isset($_SESSION['name'])) {
  ...
  <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
    <div class="page-wrapper" id="table">
      <?php
        $page = 'imsTableWithSingleOperation';
        include 'header.php'; ?>
                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>IMS Segments With Single Operation Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="imsTablesSingleOperationReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="imsTablesSingleOperationReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="imsTablesSingleOperationReport.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("segment_name" => 1))->skip($from-1);
                                }
                                echo '<tbody>';
                               ...
                               //   $tloc = $cloc + $uloc + $lloc;
                                  ...
                                  echo '<td>' . $progsystem . '</td>';
                                  echo '<td>' . $progsubsys . '</td>';
                                  echo '<td>' . $segment_name . '</td>';
                                  echo '<td>' . $dbdname . '</td>';
                                  echo '<td>' . $dbdsystem . '</td>';
								  echo '<td>' . $crud_operation . '</td>';
                                  echo '<td>' . $ssa . '</td>';
