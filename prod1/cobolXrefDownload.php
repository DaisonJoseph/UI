<?php
						...
						if(isset($_GET['input']))
						{
							header("Content-Disposition: attachment; filename=CobolCrossreference_" . $_GET['input'] . "_Download.csv");
						}
						else
						{
							header("Content-Disposition: attachment; filename=CobolCrossreference.csv");
						}
						$m = new MongoClient();
						$db = $m->aflac;
						...
						{
							$results = $collection->find(array("calling_component_type" => "COBOL"));
						}			
						...
						$out = "Calling Component Name,Calling Component Type,Application,App Owner,Called Component Name,Called Component Type,Call Type,Instance";
						echo $out . "\r\n";
						...
						foreach ($results as $result)
						{
							...
							$out = $calling_component_name . "," . $calling_component_type . "," . $app_name . "," . $app_owner . "," . $called_component_name . "," . $called_component_type . "," . $call_type . "," . $instance;
							echo $out . "\r\n";
						}
