                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<?php
								...
								{	
									...
									echo '<h5><a href="clonedQueryReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="clonedQueryReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>
                            <form action="clonedQueryReport.php" class="searchform">
