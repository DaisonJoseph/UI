                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                              if (isset($_GET['input'])) {
                                ...
                                echo '<h5><a href="callChain_download.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="callChain_download.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="callChain.php" class="searchform">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-bordered table-striped drop-shadow" style="width:100%; overflow-x: auto;">
                              ...
                              <?php
                                ...
                                // ECHO " INPUT" . $input . "<br>";
                                  ...
                                  array( 'chain' => new MongoRegex("/$input/i") ) 
                                  ));
                                 # $inputs = array('$text' => array('$search' => $input));
                                  ...
                                  $results = $collection->find(array(),array('_id'=>0))->limit(500)->skip($from);
                                }
                            ...
                            <div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="callChain.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="callChain.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
