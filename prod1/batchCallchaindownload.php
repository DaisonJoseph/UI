...
if (isset($_GET['input'])) {
     header("Content-Disposition: attachment; filename=batchcallChain_" . $_GET['input'] . "_Download.csv");
} else {
     header("Content-Disposition: attachment; filename=batchcallChain.csv");
}
$m = new MongoClient();
$db = $m->cap360;
