                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>Skeleton Cross Reference</h2>
                                                                      <?php
                                                                      if (isset($_GET['input'])) {
                                                                           $business = $_GET['input'];
                                                                           $business = str_replace(" ", "+", $business);
                                                                           echo '<h5><a href="skeletonXrefDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="skeletonXrefDownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>
                                                                      <form action="skeletonXref.php" class="searchform">
                                                            ...
                                                            <div class="x_content">
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           <thead>
                                                                                <tr>
                                                                                     <th><strong>Calling Component Name</strong></th>
                                                                                     <th><strong>Calling Component Type</strong></th>
                                                                                     <th><strong>Calling Component Application</strong></th>
                                                                                     <th><strong>Calling Component Business</strong></th>
                                                                                     <th><strong>Calling Component Scope</strong></th>
                                                                                     <th><strong>Called Component Name</strong></th>
                                                                                     <th><strong>Called Component Type</strong></th>
                                                                                     <th><strong>Called Component Application</strong></th>
                                                                                     <th><strong>Called Component Business</strong></th>
                                                                                     <th><strong>Called Component Scope</strong></th>
                                                                                     <th><strong>Step Name</strong></th>
                                                                                     <th><strong>DD Name</strong></th>
                                                                                     <th><strong>Disp Name</strong></th>
                                                                           ...
                                                                           if (isset($_GET['input']) || isset($_GET['search'])) {
                                                                                ...
                                                                                $inputs =  array('$or' => array(
                                                                                     array('$and' => array(array('calling_component_name' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('calling_component_type' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('calling_application' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('calling_business' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('calling_scope' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('called_component_name' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('called_component_type' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('called_application' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('called_business' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('called_scope' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('step_name' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('dd_name' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON"))),
                                                                                     array('$and' => array(array('disp_name' => new MongoRegex("/$input/i")), array('calling_component_type' => "SKELETON")))
                                                                                ));
                                                                                ...
                                                                                if ($numdocs == 0) {
                                                                                     $input = str_replace(" ", "-", $input);
                                                                                     $results = $collection->find($inputs)->sort(array("calling_component_type" => 0))->limit(500)->skip($from);
                                                                                }
                                                                           } else {
                                                                                $results = $collection->find(array('calling_component_type' => "SKELETON"))->limit(500)->skip($from);
                                                                           }
                                                                           echo '<tbody>';
                                                                           ...
                                                                           foreach ($results as $result) {
                                                                                ...
                                                                                echo '<tr>';
                                                                                echo '<td>' . $calling_component_name . '</td>';
                                                                                echo '<td>' . $calling_component_type . '</td>';
                                                                                echo '<td>' . $calling_application . '</td>';
                                                                                echo '<td>' . $calling_business . '</td>';
                                                                                echo '<td>' . $calling_scope . '</td>';
                                                                                echo '<td>' . $called_component_name . '</td>';
                                                                                echo '<td>' . $called_component_type . '</td>';
                                                                                echo '<td>' . $called_application . '</td>';
                                                                                echo '<td>' . $called_business . '</td>';
                                                                                echo '<td>' . $called_scope . '</td>';
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                ?>
                                                                                     <a href="skeletonXref.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom . " - " . $previousTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                if (isset($nextFrom)) {
                                                                                ?>
                                                                                     <a href="skeletonXref.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom . " - " . $nextTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
