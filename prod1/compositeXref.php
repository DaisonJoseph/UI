                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>Composite Cross Reference</h2>
                                                                      <?php
                                                                      if (isset($_GET['input'])) {
                                                                           $business = $_GET['input'];
                                                                           $business = str_replace(" ", "+", $business);
                                                                           echo '<h5><a href="compositeXrefDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="compositeXrefDownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>
                                                                      <form action="compositeXref.php" class="searchform">
                                                            ...
                                                            <div class="x_content">
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           <thead>
                                                                                <tr>
                                                                                     <th><strong>JCL Component</strong></th>
                                                                                     <th><strong>JCL App Name</strong></th>
                                                                                     <th><strong>JCL App Owner</strong></th>
                                                                                     <th><strong>Composite Component</strong></th>
                                                                           ...
                                                                           if (isset($_GET['input']) || isset($_GET['search'])) {
                                                                                ...
                                                                                $results = $collection->find()->limit(500)->skip($from);
                                                                           }
                                                                           echo '<tbody>';
                                                                           ...
                                                                           foreach ($results as $result) {
                                                                                ...
                                                                                echo '<tr>';
																				echo '<td><a href="./compositeXref.php?input='  . $jcl_component . '">' . $jcl_component . '</td>';
																				echo '<td><a href="./compositeXref.php?input='  . $jcl_app_name . '">' . $jcl_app_name . '</td>';
																				echo '<td><a href="./compositeXref.php?input='  . $jcl_app_owner . '">' . $jcl_app_owner . '</td>';
																				echo '<td><a href="./compositeXref.php?input='  . $composite_component . '">' . $composite_component . '</td>';
																				echo '<td><a href="./compositeXref.php?input='  . $called_component . '">' . $called_component . '</td>';
																				echo '<td><a href="./compositeXref.php?input='  . $instance . '">' . $instance . '</td>';
                                                                                echo '</tr>';
                                                                           }
                                                                           echo '</tbody>';
                                                                           ?>
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                ?>
                                                                                     <a href="compositeXref.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom . " - " . $previousTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                if (isset($nextFrom)) {
                                                                                ?>
                                                                                     <a href="compositeXref.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom . " - " . $nextTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
