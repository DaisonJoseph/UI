                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Paragraph Cross Reference</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="paraXrefDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="paraXrefDownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="paraXref.php" class="searchform">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
								  ...
								  <th><strong>Calling Paragraph</strong></th>
								  <th><strong>Called Paragraph</strong></th>
                              ...
                              <?php
                                ...
                                foreach ($results as $result) {
                                  ...
                                  echo '<td>' . $calling_para . '</td>';
								  echo '<td>' . $called_para . '</td>';
								  echo '</tr>';
                                }
                                echo '</tbody>';
                                ?>
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="paraXref.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="paraXref.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
