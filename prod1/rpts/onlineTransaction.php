            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-blue">
                  <h4 class="card-title ">CAP360 - ONLINE TRANSACTION REPORT</h4>
                 ...
                 <!--     <tbody>
					...
					<div class="row">
						...
						if(isset($previousFrom)){
							?>
							<a href="onlineTransaction.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
							<?php
						}
						?>
						</div>
						...
						if(isset($nextFrom)){
							?>
							<a href="onlineTransaction.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary" style="margin-left: 70%"><?php echo $nextFrom." - ".$nextTo; ?></a>
							<?php
						}
						?>
						</div>
