                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>JCL Impact</h2>
								...
								{	
									...
									echo '<h5><a href="jclImpactReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="jclImpactReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>


                            <form action="jclImpact.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("calling_component_name" => 1, "calling_component_type" => 1))->limit(500)->skip($from-1);
