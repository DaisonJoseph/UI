                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                              if (isset($_GET['input'])) {
                                ...
                                echo '<h5><a href="tsqReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="tsqReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="tsqReport.php" class="searchform">
                          ...
                          <div class="table-responsive">
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="tsqReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="tsqReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
