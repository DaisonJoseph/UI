                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                              if (isset($_GET['input'])) {
                                ...
                                echo '<h5><a href="rmdsJcldownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="rmdsJcldownload.php" > Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="rmdsJcl.php" class="searchform">
                          ...
                          <div class="table-responsive">
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="rmdsJcl.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="rmdsJcl.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
