                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>DB2 Crud Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="db2CrudReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="db2CrudReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="db2CrudReport.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><strong>Component Owner</strong></th>
                              ...
                              <?php
                               ...
                               //   $tloc = $cloc + $uloc + $lloc;
								  ...
								  echo '<td><a href="./tableSankey.php?table_name='  . $table_name . '">' . $table_name . '</td>';
