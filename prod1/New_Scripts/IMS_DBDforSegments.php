<?php
	...
	// fclose($file);
	$path = 'C:/xampp/htdocs/IMS_orphansegments_May24.csv';
...
fputcsv($outfile,array("Segment","DBD Name","System"));   
...
while(! feof($file))
{
	...
	while(! feof($file1))
	{
	   ...
	   if($data[0] == $tbname)
	   {
		 fputcsv($outfile,array($data[0],$dbname,$data[1]));  
	   }
