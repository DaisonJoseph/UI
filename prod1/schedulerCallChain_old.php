                        ...
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                              ...
                              ?>
                            <form action="schedulerCallChain.php" class="searchform">
                                    ...
                                    <?php
                                        for ($i = 0; $i < 7; $i++) {
                                          ...
                                          <td>
                                            ...
                                            <a href="callChainChart.php?chain=<?php echo $result['chain']; ?>"><?php echo $a; ?></a>
