    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
                        ...
                        <div>
                            ...
                            <div id="submenu1sub1">
                                <div class="row" style="margin-top:-5px" id="row1">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green" style="background-image: url('../assets/img/back3.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" title="Total number of tables used in the system." href="#thirdscroll">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                    ...
                                    <div class="col-lg-3  col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 purple" style="background-image: url('../assets/img/back4.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" href="#" title="Total number of PS/flat files and VSAM files used in the application">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Total LOC</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Application Component Count</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                ...
                                <div class="row" style="margin-top:-5px" id="row2">
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 yellow" style="background-image: url('../assets/img/back5.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of Orphan components that are in the application, but no longer being actively invoked or used by other components">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-turquoise" style="background-image: url('../assets/img/circlebackdark.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of Dead transaction or JCLs that are in the application, but have not being executed in the last six months">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 red-flamingo" style="background-image: url('../assets/img/tribackdark.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" title="Overall technical debt found in the entire application" href="#thirdscroll">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                    ...
                                    <div class="col-lg-3  col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 blue-madison" style="background-image: url('../assets/img/colorbackdark.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" href="#" title="Total number of components that are actively being invoked, but source code is not available">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                ...
                                <div class="row" style="margin-top:-5px" id="row3">
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-jungle" style="background-image: url('../assets/img/back6.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of online transactions that are in the application">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 red-thunderbird" style="background-image: url('../assets/img/circlebackdarker.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of online transactions that are being actively triggered in the last six months">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 purple-studio" style="background-image: url('../assets/img/tribackdarker.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" title="Total number of batch jobs that are in the application" href="#thirdscroll">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                    ...
                                    <div class="col-lg-3  col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 yellow-saffron" style="background-image: url('../assets/img/colorbackdarker.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" href="#" title="Total number of batch jobs that are being actively triggered in the last six months">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Top 5 Transaction Execution Count</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Active & Inactive JCL's </span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                ...
                                <div class="row" style="margin-top:-5px" id="row4">
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 purple-plum" style="background-image: url('../assets/img/back7.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of DB2 operations performed in the application">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                                    ...
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-sharp" style="background-image: url('../assets/img/circlebackdarkest.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Total number of tables that has only single type of operations performed over it, and most likely a technical debt">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                    <span data-counter="counterup" data-value="<?php echo number_format($total_Crud); ?>">0</span> </div>
                                                <div class="desc"> <b>Tables with Singular CRUD Operations</b> </div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 yellow-casablanca" style="background-image: url('../assets/img/tribackdarkest.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" title="Total number of tables without an index defined" href="#thirdscroll">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                    <span></span><span data-counter="counterup" data-value="<?php echo number_format($table_withNoIndex_count); ?>">0</span>
                                                </div>
                                    ...
                                    <div class="col-lg-3  col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 blue-ebonyclay" style="background-image: url('../assets/img/colorbackdarkest.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" href="#" title="Total number of occurrence of queries that has been cloned across the application">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                ...
                                                <div class="desc">
                                                    <B> Total Occurrence of Cloned Queries</B> </div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Total Crud Operations</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Singular CRUD Operations</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                            ...
                                            <div class="col-lg-6 col-sm-6 col-xs-12">
                                                <div class="portlet light bordered">
                                                    <div class="portlet-title">
                                                        <div class="caption">
                                                            <i class="icon-equalizer font-dark hide"></i>
                                                            <span class="caption-subject font-dark bold">Total Occurrence of Cloned Queries</span>
                                                            <span class="caption-helper"></span>
                                                        </div>
                                                        <div class="tools">
                                                            <a href="" class="collapse"> </a>
                                ...
                                <div class="row" style="margin-top:-5px" id="row5">
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 yellow" style="background-image: url('../assets/img/backdarkmax.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Cost to migrate the application from Mainframes and host it on LUW based platform">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->
                                                <div class="number">
                                                    <!--style="padding-left:160px;font-size:20px;color:white"-->
                                                    <span>$ &nbsp</span><span data-counter="counterup" data-value="0">0</span><span></span>
                                                </div>
                                                <div class="desc"><b> Rehosting Cost</b></div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 green-turquoise" style="background-image: url('../assets/img/circlebackdarkmax.jpg');background-size: cover;" href="#" data-toggle="tooltip" data-placement="bottom" title="Cost to remove the the technical debts and clean up the application">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                    <span>$ &nbsp</span><span data-counter="counterup" data-value="0">0</span> </div>
                                                <div class="desc"> <b> Technical Debt Removal Cost</b></div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3 col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 red-flamingo" style="background-image: url('../assets/img/tribackdarkmax.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" title="Cost to extract business rules from the application" href="#thirdscroll">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                    <span>$ &nbsp</span><span data-counter="counterup" data-value="0"></span>
                                                </div>
                                                <div class="desc"> <b>Reverse Engineering Cost</b></div>
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-3  col-sm-6 col-xs-12">
                                        <a class="dashboard-stat dashboard-stat-v2 blue-madison" style="background-image: url('../assets/img/colorbackdarkmax.jpg');background-size: cover;" data-toggle="tooltip" data-placement="bottom" href="#" title="Cost to rewrite the application into distributed languages like Java or .Net">
                                            <div class="visual">
                                            </div>
                                            <div class="details">
                                                <div class="number">
                                                    <span>$ &nbsp</span><span data-counter="counterup" data-value="0"></span></div>
                                                <div class="desc"><b>Migration Cost </b></div>
                                            </div>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="row widget-row">
                                <a data-toggle="modal" href="#" id="Portfolio">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12" id="mydiv">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high1">
                                            <h4 class="widget-thumb-heading">Missing Tables</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-briefcase"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"></span>
                                                    <span class="widget-thumb-body-stat" style="color:white" data-counter="counterup" data-value="26">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END WIDGET THUMB -->
                                ...
                                <a data-toggle="modal" href="#" id="Applications">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high2">
                                            <h4 class="widget-thumb-heading">Fields not used</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-desktop"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"> </span>
                                                    <span class="widget-thumb-body-stat" style="color:white" data-counter="counterup" data-value="76">0</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <a data-toggle="modal" href="#" id="People">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high3">
                                            <h4 class="widget-thumb-heading">COBOL - Static Calls</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-users"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"></span>
                                                    <span class="widget-thumb-body-stat" data-counter="counterup" style="color:white" data-value="<?php echo number_format($static_call); ?>">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END WIDGET THUMB -->
                                ...
                                <a data-toggle="modal" href="#" id="Tools">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high4">
                                            <h4 class="widget-thumb-heading">COBOL - Dynamic Calls</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-wrench"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"></span>
                                                    <span class="widget-thumb-body-stat" data-counter="counterup" style="color:white" data-value="<?php echo number_format($dynamic_call); ?>">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END WIDGET THUMB -->
                                ...
                                <a data-toggle="modal" href="#" id="Vendors">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high5">
                                            <h4 class="widget-thumb-heading">Source Without Load</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-user-plus"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"></span>
                                                    <span class="widget-thumb-body-stat" data-counter="counterup" style="color:white" data-value="<?php echo number_format($sourceNA); ?>">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END WIDGET THUMB -->
                                ...
                                <a data-toggle="modal" href="#" id="ROI">
                                    ...
                                    <div class="col-lg-2 col-sm-6 col-xs-12">
                                        <!-- BEGIN WIDGET THUMB -->
                                        <div class="widget-thumb widget-bg-color-white text-uppercase" style="height: 110px; background-image:url('../assets/img/smally.jpg'); background-size:cover" id="high6">
                                            <h4 class="widget-thumb-heading">Load Without Source</h4>
                                            <div class="widget-thumb-wrap">
                                                <i class="widget-thumb-icon fa fa-line-chart"></i>
                                                <div class="widget-thumb-body">
                                                    <span class="widget-thumb-subtitle"></span>
                                                    <span class="widget-thumb-body-stat" data-counter="counterup" style="color:white" data-value="<?php echo number_format($loadNA); ?>">0</span>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- END WIDGET THUMB -->
        ...
        <script>
            ...
            series.slices.template.events.on("hit", function(ev) {
                window.location = "http://10.246.88.97/cap360-material/prod1/masterReports.php";
            });
        </script>
        <script>
            // chart 2 
        ...
        <script>
            ...
            chart.data = [{
                "country": "JCL",
                "litres": <?php echo $jcl_count; ?>
            }, {
                "country": "TRANSACTION",
                "litres": <?php echo $trans_count; ?>
            }];

            chart.innerRadius = 97;
        ...
        <script>
            ...
            series.name = "Income";
            series.columns.template.propertyFields.fill = "color";
            series.columns.template.tooltipText = "[bold]{categoryY}[/]:{valueX}";
            series.columns.template.column3D.stroke = am4core.color("#fff");
            series.columns.template.column3D.strokeOpacity = 0.2;
        </script>
