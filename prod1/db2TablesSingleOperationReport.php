                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>DB2 Tables with Single Operation</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="db2SingleOperationdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="db2SingleOperationdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="db2TablesSingleOperationReport.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
								  ...
								  <th><strong>System</strong>
								  </th><th><strong>Subsystem</strong></th>
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("component_type" => 1))->limit(500)->skip($from-1);
                                }
                                echo '<tbody>';
