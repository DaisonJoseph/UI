                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>IMS Impact</h2>
								...
								{	
									...
									echo '<h5><a href="imsImpactReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="imsImpactReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>


                            <form action="imsImpact.php" class="searchform">
