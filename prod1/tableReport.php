...
// require '/var/www/html/cap360/CAP360_Autmation/php/BL/Config/AutoMyMongo.php'; 				//# 
                      ...
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            <?php
                                echo '<h5><a href="tableReportsdownload.php?table_name='. $tableName .'"> Download Excel Report </a></h5>';
                              ?>
                            </form>
                          </div>
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><strong>No. of Queries</strong></th>
                                </tr>
                              </thead>
                              <?php
                                $m = new MongoClient();
								...
								foreach($crudResults as $crudResult)
								{
									...
									// $operationCounts = array_count_values($totalOperations);
									// foreach ($operationCounts as $uniqueOpeartion => $operationCount)
									// {
										// $consolidated = $tableName."|".$uniqueOpeartion."|".$operationCount;
                               ...
                               // //   $tloc = $cloc + $uloc + $lloc;
                                  ...
                                  echo '<td>' . $exploded[0] . '</td>';
                                  echo '<td>' . $exploded[1] . '</td>';
                                  echo '<td>' . $exploded[2] . '</td>';
                                  echo '<td>' . $exploded[3] . '</td>';
                                  echo '</tr>';
                                }
                                echo '</tbody>';
                                ?>
