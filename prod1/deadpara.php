                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Dead Para Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="deadparadownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="deadparadownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="deadpara.php" class="searchform">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><strong>Paragraph Name</strong></th>
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
								  ...
								  $inputs =  array( '$or' => array(
									...
									array( 'paragraph_name' => $inputcase ),
									array( 'section_name' => $inputcase ),
									array( 'loc' => $input )
									));
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="deadpara.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="deadpara.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
