                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>String Impact</h2>
								...
								{	
									...
									echo '<h5><a href="stringImpactReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="stringImpactReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("Type" => 1, "Program" => 1))->limit(500)->skip($from-1);
