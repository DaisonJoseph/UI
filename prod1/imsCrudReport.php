                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>IMS Crud Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="imsCrudReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="imsCrudReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="imsCrudReport.php" class="searchform">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
                                  ...
                                  <th><strong>Segment Application</strong></th>
                                  <th><strong>Segment Business</strong></th>
                                  <th><strong>Segment Scope</strong></th>
                                  <th><strong>Operation</strong></th>
								  <th><strong>DBD</strong></th>
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
								  ...
								  $inputs =  array( '$or' => array(
									...
									array( 'segment_name' => new MongoRegex("/$inputcase/i") ) ,
									array( 'segment_application' => new MongoRegex("/$inputcase/i") ),
									array( 'segment_scope' => new MongoRegex("/$inputcase/i") ),
									array( 'segment_business' => new MongoRegex("/$inputcase/i") ),
									array( 'operation' => new MongoRegex("/$inputcase/i") ),
									array( 'dbd' => new MongoRegex("/$inputcase/i") ),
									array( 'ssa' => new MongoRegex("/$inputcase/i") ),
                                ...
                                foreach ($results as $result) {
									$segment_application = $result['segment_application'];
									$segment_scope = $result['segment_scope'];
									$segment_business = $result['segment_business'];
                               ...
                               //   $tloc = $cloc + $uloc + $lloc;
                                  ...
                                  echo '<td>' . $segment_application . '</td>';
                                  echo '<td>' . $segment_business . '</td>';
                                  echo '<td>' . $segment_scope . '</td>';
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="imsCrudReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="imsCrudReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
