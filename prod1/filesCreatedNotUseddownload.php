<?php
						...
						if(isset($_GET['input']))
						{
							header("Content-Disposition: attachment; filename=fileCreatedNotUsed" . $_GET['input'] . "_Download.csv");
						}
						else
						{
							header("Content-Disposition: attachment; filename=fileCreatedNotUsed.csv");
						}
						$m = new MongoClient();
						$db = $m->cap360;
						...
						$out = "File Name,Type,Application,Business,Scope";
						echo $out . "\r\n";
						...
						foreach ($results as $result)
						{
							...
							$out = $file_name.",".$type.",".$application.",".$business.",".$scope;
							echo $out . "\r\n";
						}
