...
$total = $collection->find(array("Component_Type"=>"TRANSACTION"))->count();
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
							...
							<?php
								...
								{	
									...
									echo '<h5><a href="onlineTransactiondownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="onlineTransactiondownload.php"> Download Excel Report </a></h5>';
								}
								?>
                            <form action="onlineTransaction.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find(array("Component_Type"=>"TRANSACTION"))->sort(array("Component_Name" => 1))->limit(500)->skip($from);
