                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>Application Interface Report</h2>
                                                                      <?php
                                                                      if (isset($_GET['input'])) {
                                                                           $business = $_GET['input'];
                                                                           $business = str_replace(" ", "+", $business);
                                                                           echo '<h5><a href="appInterfaceReportDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="appInterfaceReportDownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>
                                                                      <form action="appInterfaceReport.php" class="searchform">
                                                            ...
                                                            <div class="x_content">
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           <thead>
                                                                                <tr>
                                                                                     <th><strong>Calling Application</strong></th>
                                                                                     <th><strong>Calling Scope</strong></th>
                                                                                     <th><strong>Calling Business</strong></th>
                                                                                     <th><strong>Called Application</strong></th>
                                                                                     <th><strong>Called Scope</strong></th>
                                                                                     <th><strong>Called Business</strong></th>
                                                                           ...
                                                                           if (isset($_GET['input']) || isset($_GET['search'])) {
                                                                                ...
                                                                                $results = $collection->find()->sort(array("calling_application" => 1))->limit(500)->skip($from);
                                                                           }
                                                                           echo '<tbody>';
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                ?>
                                                                                     <a href="appInterfaceReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom . " - " . $previousTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                if (isset($nextFrom)) {
                                                                                ?>
                                                                                     <a href="appInterfaceReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom . " - " . $nextTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
