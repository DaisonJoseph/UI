...
$m = new MongoClient();
$db = $m->aflac;
$collection = $db->cobol_crossreference;
                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>COBOL Cross Reference</h2>
                                                                      <?php
                                                                      if (isset($_GET['input'])) {
                                                                           $business = $_GET['input'];
                                                                           $business = str_replace(" ", "+", $business);
                                                                           echo '<h5><a href="cobolXrefDownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="cobolXrefDownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>
                                                                      <form action="cobolXref.php" class="searchform">
                                                                 ...
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           ...
                                                                           if (isset($_GET['input']) || isset($_GET['search'])) {
                                                                                ...
                                                                                $inputs =  array('$or' => array(array('app_code' => new MongoRegex("/$inputcase/i")),
                                                                                     ...
                                                                                     array('call_type' => new MongoRegex("/$inputcase/i")),
                                                                                ...
                                                                                $results = $collection->find(array("calling_component_type" => "COBOL"))->limit(500)->skip($from);
                                                                           }
                                                                           echo '<tbody>';
                                                                           ...
                                                                           foreach ($results as $result) {
                                                                                ...
                                                                                echo '<tr>';
																				echo '<td><a href="./cobolXref.php?input='  . $calling_component_name . '">' . $calling_component_name . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $calling_component_type . '">' . $calling_component_type . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $app_name . '">' . $app_name . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $app_owner . '">' . $app_owner . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $called_component_name . '">' . $called_component_name . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $called_component_type . '">' . $called_component_type . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $call_type . '">' . $call_type . '</td>';
																				echo '<td><a href="./cobolXref.php?input='  . $instance . '">' . $instance . '</td>';
                                                                                echo '</tr>';
                                                                           }
                                                                           echo '</tbody>';
                                                                           ?>
                                                                      ...
                                                                      <div class="row">
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                ?>
                                                                                     <a href="cobolXref.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom . " - " . $previousTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
                                                                           <div class="col-sm-6">
                                                                                ...
                                                                                if (isset($nextFrom)) {
                                                                                ?>
                                                                                     <a href="cobolXref.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom . " - " . $nextTo; ?></a>
                                                                                <?php
                                                                                }
                                                                                ?>
                                                                           </div>
