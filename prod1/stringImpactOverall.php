                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>Overall SSN Impact</h2>
                                                               <?php
								if (isset($_GET['input']))
								{	
									$business =$_GET['input'];
									$business = str_replace(" ","+",$business);
									echo '<h5><a href="stringImpactOverallReportdownload.php?input='. $business .'"> Download Excel Report </a></h5>';
								}
								else
								{
									echo '<h5><a href="stringImpactOverallReportdownload.php"> Download Excel Report </a></h5>';
								}
								?>


                            <form action="stringImpactOverall.php" class="searchform">
                            ...
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              ...
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
                                  ...
                                  $results = $collection->find()->sort(array("component_type" => 1, "component_name" => 1))->limit(500)->skip($from-1);
