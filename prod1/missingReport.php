                                                            ...
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      ...
                                                                      if (isset($_GET['input'])) {
                                                                           ...
                                                                           echo '<h5><a href="missingReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                                                                      } else {
                                                                           echo '<h5><a href="missingReportdownload.php"> Download Excel Report </a></h5>';
                                                                      }
                                                                      ?>


                                                                      <form action="missingReport.php" class="searchform">
