...
?>
	 ...
	 .delbtn {
  background-color: #8DCAFA!important;
  border: none;
  color: white;
  padding: 12px 16px;
  font-size: 14px;
  ...
  border-radius: 8px!important;
	 ...
	 .delbtn:hover {
  background-color: #51AEF7!important;
	}
	</style>
     <meta charset="utf-8" />
     ...
     <body class="page-header-fixed page-sidebar-closed-hide-logo page-content-white page-sidebar-fixed">
                                             ...
                                             <div class="row">
                                                  <div class="col-md-12 col-sm-12 col-xs-12">
                                                       <div class="x_panel container drop-shadow" style="background-color: white;">
                                                            <div class="x_title">
                                                                 <div class="col-md-12 col-sm-12 col-xs-12">
                                                                      <h2>Components to be neglected</h2>
                                                                 </div>
																 <div class="card-body">
																	<div class="row">
																		<div class="col-md-12">
																			<!-- BEGIN FORM--> <br>
																			<div>
																				<form action="removeComponent.php" method="post" style="left:10px">
																						<div class= "row" style="text-align:left;">
																							<div class="col-lg-2" style="padding:0px;">
																								<h5 style="margin:5px 10px;padding-left: 20px;">Component Name:</h5>
																							</div>	
																							<div class="col-lg-2">
																								<input id="compname" class="form-control" type="text" placeholder="Component Name.." name="component_name" style="width: 146px;">
																							</div>
																							<div class="col-lg-2" style="padding:0px;">
																								<h5 style="margin:5px 12px;padding-left: 20px;">Component Type:</h5>
																							</div>	
																							<div class="col-lg-2">
																								<input id="comptype" class="form-control" type="text" placeholder="Component Type.." name="component_type" style="width: 146px;">
																							</div>
																							<div class="col-lg-2" style="margin-left:30px">
																								<input style="border-radius: 8%!important;" class="btn btn-primary" type="submit" value="Submit" name="submit">
																							</div>	
																						</div>
																				</form>
																			</div>
                                                            ...
                                                            <div class="x_content">
                                                                 <div class="table-responsive">
                                                                      <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                                                                           ...
                                                                           <?php
                                                                                $results = $remove_component_collection->find()->sort(array('timestamp' => -1));
                                                                           echo '<tbody>';

                                                                           foreach ($results as $result) {
                                                                                $remove_name = $result['remove_name'];
                                                                                $remove_type = $result['remove_type'];

                                                                                //   $tloc = $cloc + $uloc + $lloc;


                                                                                echo '<tr>';
                                                                                echo '<td>' . $remove_name . '</td>';
                                                                                echo '<td>' . $remove_type . '</td>';?>
																				<td><button type="submit" class="delbtn" id="myBtn" onclick='show_alert(<?php echo '"'.$remove_name.'"'; ?>)' value="<?php echo $remove_name."_".$remove_type;?>"><i class="fa fa-trash"></i></button></td>
																				<?php
                                                                                echo '</tr>';
                                                                           }
                                                                           echo '</tbody>';
      ...
      <script src="https://cdn.datatables.net/buttons/1.6.0/js/buttons.print.min.js"></script> -->
               ...
               <script>
					...
					function show_alert(btnvalue) {
						// var btnvalue = document.getElementById("myBtn").value;
						// alert(btnvalue); 
						var r = confirm("Sure to delete the "+btnvalue);
						if (r === true) {
							$.ajax({
								url: "deleteNeglectedComponent.php?compname=" + btnvalue,
								type: "get",
								dataType:"json",
								success: function(response) {
									if(response.Status){
										window.location.href="neglectComponent.php";
									} else{
