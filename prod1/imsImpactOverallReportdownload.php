<?php
						...
						if(isset($_GET['input']))
						{
							header("Content-Disposition: attachment; filename=imsImpactOverall_" . $_GET['input'] . "_Download.csv");
						}
						else
						{
							header("Content-Disposition: attachment; filename=imsImpactOverall.csv");
						}
						$m = new MongoClient();
						$db = $m->ryder;
