                  ...
                  <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12">
                      <div class="x_panel container drop-shadow" style="background-color: white;">
                        <div class="x_title">
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            <h2>IMS Image Copy Report</h2>
                            <?php
                              if (isset($_GET['input'])) {
                                $business = $_GET['input'];
                                $business = str_replace(" ", "+", $business);
                                echo '<h5><a href="imsimageCopyReportdownload.php?input=' . $business . '"> Download Excel Report </a></h5>';
                              } else {
                                echo '<h5><a href="imsimageCopyReportdownload.php"> Download Excel Report </a></h5>';
                              }
                              ?>
                            <form action="imsimageCopyReport.php" class="searchform">
                          ...
                          <div class="table-responsive">
                            <table id="example" class="table table-bordered drop-shadow" style="width:100%">
                              <thead>
                                <tr>
								  ...
								  <th><strong>Database System</strong></th>
                                  <th><strong>Image Copy File</strong></th>
								  <th><strong>Image Copy File System</strong></th>
                                </tr>
                              </thead>
                              <?php
                                if (isset($_GET['input']) || isset($_GET['search'])) {
								  ...
								  $inputs =  array( '$or' => array(
									...
									array( 'image_copy_file' => $inputcase ),
									array( 'image_copy_file_system' => $inputcase )
                                  ...
                                  $results = $collection->find()->sort(array("system" => 1))->limit(500)->skip($from);
                                }
                                echo '<tbody>';
                               ...
                               //   $tloc = $cloc + $uloc + $lloc;
								  ...
								  echo '<td>' . $system . '</td>';
								  echo '<td>' . $subsystem . '</td>';
								  echo '<td>' . $dbd . '</td>';
								  echo '<td>' . $dbd_system . '</td>';
                                  echo '<td>' . $image_copy_file . '</td>';
								  echo '<td>' . $image_copy_file_system . '</td>';
                                  echo '</tr>';
                                }
                                echo '</tbody>';
                                ?>
							...
							<div class="row">
                              ...
                              if(isset($previousFrom)){
                                ?>
                                <a href="imsimageCopyReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
                              ...
                              if(isset($nextFrom)){
                                ?>
                                <a href="imsimageCopyReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary pull-right"><?php echo $nextFrom." - ".$nextTo; ?></a>
                                <?php
                              }
                              ?>
                              </div>
