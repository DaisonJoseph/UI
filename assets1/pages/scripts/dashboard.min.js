    ...
    return {
        ...
        initJQVMAP: function() {
            ...
            var setMap = function(name) {
				...
				data.map = name + '_en';
				if(data.map == 'world_en')
				{
					data.values = sample_data;
					
				}
				else if(data.map == 'world1_en')
				{
					data.values = sample_data1;
				}
				else if(data.map == 'world2_en')
				{
					data.values = sample_data2;
				}
				else if(data.map == 'world3_en')
				{
					data.values = sample_data3;
				}
				else 
				{
					data.values = sample_data4;
				}
