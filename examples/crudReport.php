            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-blue">
                  <h4 class="card-title ">CAP360 - CRUD REPORT</h4>
                  ...
                  <div class="table-responsive">
                    <table id="example" class="table table-bordered" style="width:100%">
                     ...
                     <!--     <th><strong>Called Component Name</strong></th>
					  ...
					  <?php
					  $results = $collection->find()->sort(array("Program_Name"=>1,"Operation"=>-1))->limit(500)->skip($from);
					  echo '<tbody>';
                 ...
                 <!--     <tbody>
					...
					<div class="row">
						...
						if(isset($previousFrom)){
							?>
							<a href="crudReport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
							<?php
						}
						?>
						</div>
						...
						if(isset($nextFrom)){
							?>
							<a href="crudReport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary" style="margin-left: 70%"><?php echo $nextFrom." - ".$nextTo; ?></a>
							<?php
						}
						?>
						</div>
