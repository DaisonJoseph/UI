...
<head>
  ...
  <title>CAP360 - Call Chain Report</title>
  <!-- Favicon -->
...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->	
        <h1 style="color:#fff">CAP360 - Call Chain Report</h1>
        <!-- Form -->
        <!-- User -->
						...
						<div class="col-sm-8">
							<div class="row">
								...
								if (isset($_GET['input'])) {
									...
									echo '<h5><a class="btn btn-primary" href="callchaindownload.php?input='. $business .'"> Download Excel </a></h5>';
								} else{
									echo '<h5><a class="btn btn-primary" href="callchaindownload.php"> Download Excel </a></h5>';
								}
								?>
           			</div>
							</div>
                  ...
                  <div class="x_content">
					...
					<?php
						...
						foreach ($results as $result)
						{
							...
							echo '<tr>';
							echo '<td>'. $business . '</td>';
							echo '<td>'. $first_level . '</td>';
						  echo '<td>'. $first_type . '</td>';
						  echo '<td>'. $second_level . '</td>';
						  echo '<td>'. $second_type . '</td>';
						  echo '<td>'. $third_level . '</td>';	
						  echo '<td>'. $third_type . '</td>';	
						  echo '<td>'. $fourth_level . '</td>';	
						  echo '<td>'. $fourth_type . '</td>';
						  echo '<td>'. $fifth_level . '</td>';	
						  echo '<td>'. $fifth_type . '</td>';
						  echo '<td>'. $sixth_level . '</td>';	
						  echo '<td>'. $sixth_type . '</td>';
						  echo '<td>'. $seventh_level . '</td>';	
						  echo '<td>'. $seventh_type . '</td>';
						  echo '<td>'. $eigth_level . '</td>';	
						  echo '<td>'. $eigth_type . '</td>';						  
							echo '</tr>';
						}
						echo '</tbody>';
					?>
					...
					<div class="row">
						...
						if(isset($previousFrom)){
							?>
							<a href="callchainreport.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
							<?php
						}
						?>
						</div>
						...
						if(isset($nextFrom)){
							?>
							<a href="callchainreport.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary" style="margin-left: 70%"><?php echo $nextFrom." - ".$nextTo; ?></a>
							<?php
						}
						?>
						</div>
