...
<head>
  ...
  <title>CAP360 - Cross Reference</title>
  <!-- Favicon -->
...
<body>
			...
			<li class="nav-item">
			  ...
			  <div class="collapse" id="navbar-dashboards">
				<ul class="nav nav-sm flex-column">
				  ...
				  <li class="nav-item">
					<a href="crossreference.php" class="nav-link">Master Inventory</a>
				  </li>
				  <li class="nav-item">
					<a href="crossreference.php" class="nav-link active">Cross Reference</a>
				  </li>
				  <li class="nav-item">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->	
        <h1 style="color:#fff">CAP360 - Cross Reference</h1>
        <!-- Form -->
        <!-- User -->
						...
						<div class="col-sm-8">
							<div class="row">
								...
								if (isset($_GET['input'])) {
									...
									echo '<h5><a class="btn btn-primary" href="crossreferencereportdownload.php?input='. $business .'"> Download Excel </a></h5>';
								} else{
									echo '<h5><a class="btn btn-primary" href="crossreferencereportdownload.php"> Download Excel </a></h5>';
								}
								?>
           			</div>
							</div>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered" style="width:100%">
                      <thead>
                        <tr>
                          ...
                          <th>Called Component Name</th>
						  <th>Called Component Type</th>
                        </tr>
                      </thead>
					...
					<?php
						...
						foreach ($results as $result)
						{
							...
							echo '<tr>';
							//echo '<td><a href="./crossreference.php?input='  . $calling_component_name . '">' . $calling_component_name . '</td>';
							//echo '<td><a href="./crossreference.php?input='  . $calling_component_type . '">' . $calling_component_type . '</td>';
					...
					<div class="row">
						...
						if(isset($previousFrom)){
							?>
							<a href="crossreference.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
							<?php
						}
						?>
						</div>
						...
						if(isset($nextFrom)){
							?>
							<a href="crossreference.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary" style="margin-left: 70%"><?php echo $nextFrom." - ".$nextTo; ?></a>
							<?php
						}
						?>
						</div>
