...
$m = new MongoClient();
$db = $m->testing;
$collection = $db->tables_inventory;
...
<head>
  ...
  <title>CAP360 - Tables Inventory</title>
  <!-- Favicon -->
...
<body>
			...
			<li class="nav-item">
			  ...
			  <div class="collapse" id="navbar-dashboards">
				<ul class="nav nav-sm flex-column">
				  ...
				  <li class="nav-item">
					<a href="tablesinventory.php" class="nav-link active">Tables Inventory</a>
				  </li>
			<!--	  <li class="nav-item">
					<a href="masterinventory.php" class="nav-link">Master Inventory</a>
				  </li>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->	
        <h1 style="color:#fff">CAP360 - Tables Inventory</h1>
        <!-- Form -->
        <!-- User -->
				...
				<table class="table table-hover" id="example" cellspacing="0">
					...
					<tbody>
						...
						<tr>
							...
							<td><?php echo $document["SELECT"];?></td>
							<td><?php echo $document["UPDATE"];?></td>
							<td><?php echo $document["DELETE"];?></td>
							<td><?php echo $document["INSERT"];?></td>
							<td><?php echo $document["orphan"];}?></td>
						</tr>				
					</tbody>
				</table>
			</div><!-- Card body END -->
