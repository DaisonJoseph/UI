...
<head>
  ...
  <title>CAP360 - Master Inventory</title>
  <!-- Favicon -->
...
<body>
			...
			<li class="nav-item">
			  ...
			  <div class="collapse" id="navbar-dashboards">
				<ul class="nav nav-sm flex-column">
				  ...
				  <li class="nav-item">
					<a href="masterinventory.php" class="nav-link active">Master Inventory</a>
				  </li>
				  <li class="nav-item">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->	
        <h1 style="color:#fff">CAP360 - Master Inventory</h1>
        <!-- Form -->
        <!-- User -->
						...
						<div class="col-sm-8">
							<div class="row">
								...
								if (isset($_GET['input'])) {
									...
									echo '<h5><a class="btn btn-primary" href="masterinventoryreportdownload.php?input='. $business .'"> Download Excel </a></h5>';
								} else{
									echo '<h5><a class="btn btn-primary" href="masterinventoryreportdownload.php"> Download Excel </a></h5>';
								}
								?>
           			</div>
							</div>
                  ...
                  <div class="x_content">
					...
					<?php
						...
						foreach ($results as $result)
						{
							...
							//$dropimpact = $result['dropimpact'];
							//$in_scope = $result['scope'];
							//$endevour = $result['endevourCode'];
							$tloc = $cloc + $uloc + $lloc;
							//$orphan = $result['orphan'];


							echo '<tr>';
							//echo '<td><a href="./masterinventory.php?input='  . $component_name . '">' . $component_name . '</td>';
							//echo '<td><a href="./masterinventory.php?input='  . $component_type . '">' . $component_type . '</td>';
					...
					<div class="row">
						...
						if(isset($previousFrom)){
							?>
							<a href="masterinventory.php?from=<?php echo $previousFrom; ?>&to=<?php echo $previousTo; ?>" class="btn btn-primary"><?php echo $previousFrom." - ".$previousTo; ?></a>
							<?php
						}
						?>
						</div>
						...
						if(isset($nextFrom)){
							?>
							<a href="masterinventory.php?from=<?php echo $nextFrom; ?>&to=<?php echo $nextTo; ?>" class="btn btn-primary" style="margin-left: 70%"><?php echo $nextFrom." - ".$nextTo; ?></a>
							<?php
						}
						?>
						</div>
