...
function createContainer2(container, seriesType) {
  ...
  chart.data = [{
    "type": "COBOL",
    "litres": 500,
    "subData": [{ name: "LLOC", value: 12319532 }, { name: "ULOC", value: 9392191 }, { name: "CLOC", value: 2927341 }]
  }, {
    "type": "COPYBOOK",
    "litres": 300,
    "subData": [{ name: "LLOC", value: 1601040 }, { name: "ULOC", value: 1570246 }, { name: "CLOC", value: 30794 }]
  }, {
    "type": "DBDLIB",
    "litres": 200,
    "subData": [{ name: "LLOC", value: 1198 }, { name: "ULOC", value: 426 }, { name: "CLOC", value: 772 }]
  }];
...
function createSunburst(chart, seriesType) {
  ...
  chart.data = [{
    ...
    children: [
      { name: "COBOL", value: 44040 },
      { name: "COPYBOOK", value: 86082 },
      { name: "FILE", value: 36095 },
      { name: "JCL", value: 4 },
      { name: "PARMLIB", value: 5167 },
      { name: "PROC", value: 3160 },
      { name: "PSB", value: 3570 },
      { name: "SYSIN", value: 59 },
      { name: "UTILITY", value: 4624 }
    ]
  },
  {
    name: "Calling Cross-reference",
    children: [
      { name: "COBOL", value: 117676 },
      { name: "JCL", value: 57175 },
      { name: "TRANSACTION", value: 7950 }
    ]
  }];
...
function createXYChart2(chart, seriesType) {
  ...
  chart.data = [{
    "type": "Load Avail & Source Not Avail",
    "value": 97
  }, {
    "type": "Source Avail & Load Not Avail",
    "value": 124
  }];
...
function createXY3DChart2(chart, seriesType) {
  chart.data = [{
    "type": "VP Securities maintenance",
    "value": 301
  }, {
...
function createXY3DChart3(chart, seriesType) {
  ...
  // Create series
  var series = chart.series.push(new am4charts[seriesType]());
  series.dataFields.valueY = "insertOnly";
  series.dataFields.categoryX = "type";
  series.name = "Insert Only";
  series.clustered = false;
  series.columns.template.tooltipText = "Insert Only: [bold]{valueY}[/]";
